...
text <- pdf_text("/Users/taufiqahmad/Desktop/Code/CompText_Jour/exercises/Week_10/AIW.pdf")

#pdf_text reads the text from a PDF file.
writeLines(text, "/Users/taufiqahmad/Desktop/Code/CompText_Jour/exercises/Week_10/AIW.txt")
...
file_path <- "~/Desktop/Code/CompText_Jour/exercises/Week_10/AIW.txt"
...
output_dir <- "/Users/taufiqahmad/Desktop/Code/CompText_Jour/exercises/Week_10/Extracted"
for (i in seq_along(documents)) {
  output_file <- file.path(output_dir, paste0("AIW_extracted", i, ".txt"))
...
```{r}
AIW_index <- read_lines("/Users/taufiqahmad/Desktop/Code/CompText_Jour/exercises/Week_10/Extracted/AIW_extracted1.txt")
...
write_csv(final_data, "Week_10/final_data.csv")
...
files <- list.files("/Users/taufiqahmad/Desktop/Code/CompText_Jour/exercises/Week_10/Extracted", pattern="*.txt") %>% 
  as.data.frame() |> 
  rename(filename = 1) |> 
...
final_data <- read.csv("Week_10/final_data.csv")

final_index <- final_data |> 
  inner_join(files, c("index")) |> 
#you need the actual hard-coded path on this line below to the text
  
  # mutate(filepath = paste0("/Users/taufiqahmad/Desktop/Code/CompText_Jour/exercises/Week_10/Extracted", filename))
  mutate(filepath = paste0("/Users/taufiqahmad/Desktop/Code/CompText_Jour/exercises/Week_10/Extracted", filename))
...
#write.csv(/Users/taufiqahmad/Desktop/Code/CompText_Jour/exercises/Week_10/final_data.csv)
