...
text <- pdf_text("/Users/taufiqahmad/Desktop/Code/CompText_Jour/exercises/Week_9/AI_yao_taufiq.PDF")
#pdf_text reads the text from a PDF file.
writeLines(text, "/Users/taufiqahmad/Desktop/Code/CompText_Jour/exercises/Week_9/AI_yao_taufiq.txt")
...
file_path <- "/Users/taufiqahmad/Desktop/Code/CompText_Jour/exercises/Week_9/AI_yao_taufiq.txt"
...
output_dir <- "/Users/taufiqahmad/Desktop/Code/CompText_Jour/exercises/Week_9/Extracted"
...
```{r}
taufiq_index <- read_lines("/Users/taufiqahmad/Desktop/Code/CompText_Jour/exercises/Week_9/Extracted/AI_yao_extracted_1.txt")
# Extract lines 16 to 58
extracted_lines <- taufiq_index[16:540]
...
write_csv(final_data, "Week_9/yao_taufiq_index.csv")
...
```{r}
article1 <- read_lines("/Users/taufiqahmad/Desktop/Code/CompText_Jour/exercises/Week_9/Extracted/AI_yao_extracted_1.txt")

# Extract lines 16 to 58
article1_cleaned <- article1[546:661]

writeLines(article1_cleaned, "/Users/taufiqahmad/Desktop/Code/CompText_Jour/exercises/Week_9/Extracted/AI_yao_extracted_1.txt")
...
files <- list.files("/Users/taufiqahmad/Desktop/Code/CompText_Jour/exercises/Week_9/Extracted", pattern="*.txt") %>% 
  as.data.frame() |> 
  rename(filename = 1) |> 
...
#you need the actual hard-coded path on this line below to the text
  mutate(filepath = paste0("/Users/taufiqahmad/Desktop/Code/CompText_Jour/exercises/Week_9/Extracted", filename))
...
write.csv(articles_df, "/Users/taufiqahmad/Desktop/Code/CompText_Jour/exercises/Week_9/Extracted")
```
