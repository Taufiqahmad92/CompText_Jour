...
text <- pdf_text("/Users/taufiqahmad/Desktop/Code/CompText_Jour/exercises/Week_11/moley_news.PDF")

#pdf_text reads the text from a PDF file.
writeLines(text, "/Users/taufiqahmad/Desktop/Code/CompText_Jour/exercises/Week_11/moley_news.text")
...
file_path <- "/Users/taufiqahmad/Desktop/Code/CompText_Jour/exercises/Week_11/moley_news.text"
...
output_dir <- "/Users/taufiqahmad/Desktop/Code/CompText_Jour/exercises/Week_11/Extracted"
...
```{r}
Moley_index <- read_lines("/Users/taufiqahmad/Desktop/Code/CompText_Jour/exercises/Week_11/Extracted/moley_extracted1.txt")
...
write_csv(final_data, "Week_11/final_data.csv")
...
mutate(filepath = paste0("../exercises/Week_11/Extracted/", filename))
...
#write.csv(//Users/taufiqahmad/Desktop/Code/CompText_Jour/exercises/Week_11/final_data.csv)
```
...
remove_pattern <- paste(
  ...
  "aaa|predated|a_woman_to_reckon_with_the_vision_and_legacy_of_fran|ab_se|",
